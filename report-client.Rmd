...
Figures \@ref(fig:marion-nb-calendar) and \@ref(fig:marion-sb-calendar) show that both travel types follow a similar time pattern. However, the difference in travel times between the types is much wider than that exhibited by South Road per figures \@ref(fig:nb-calendar) and \@ref(fig:sb-calendar).
...
Figure \@ref(fig:marion-times-scatter) shows that a positive relationship exists both travel types during the morning rush hour towards the city. While a relationship does not seem present during the evening rush hour away from the city.
...
\@ref(tab:marion-general-corr) displays the correlation figures between the travel times. Only the travel times during the morning towards the city shows a relatively strong correlation.
...
Figure \@ref(fig:marion-std-time-dist) shows that travel times within the same time period generally the same level of variation across the rush hour periods and travel directions.
...
Figure \@ref(fig:marion-std-scatter) and table \@ref(tab:marion-std-corr) show that slight relationship exists between the standardized travel times during the morning rush hour towards the city, and no relationship exists otherwise. South Road, on the other hand, displays a positive relationship between the standardized travel times during the morning towards the city and during the evening away from the city, as shown in \@ref(fig:std-scatter) and \@ref(tab:std-corr).
...
-   conducting the analysis on previous periods to provide an indication of the rate of decline of bus network resilience to congestion
