...
linkids_dir2 <- linkids_dir2[min(which(str_starts(tolower(linkids_dir2$start_loc), tolower(dir2_start_loc)))):
                               max(which(str_starts(tolower(linkids_dir2$end_loc), tolower(dir2_end_loc)))),]
