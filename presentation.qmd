...
-   Non-overlapping sequence of links to avoid double counting

-   Approximately same length as stops pair length
...
-   northbound travel towards the city: travel times are the same for both rush hours, and the travel time in the rush hours are not much greater than non-rush hour times
...
-   Allows examination of the relationship of variations from "normal"
