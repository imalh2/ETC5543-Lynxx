---
title: "Road Congestion and Bus Travel Times"
...
Different pairs of start-end stops per direction lead to inconsistent travel times
...
-   To allows cross examination of variations from "normal"
...
-   In the evening from the city, travel time is greater and more varied than travel time in the morning to the city across the entire peak time and period

-   The standardization with respect to time of day shows that morning travel times to the city vary to a greater extent than evening travel times from the city

-   The evening southbound correlation is strong between the standardized travel times, however the variations are relatively small, therefore it's difficult to infer the bus transportation robustness to congestion

-   The morning standardized travel times towards the city are more varied and the correlation is lower, implying the bus transportation is relatively more robust to congestion

## Future Directions

-   Analyze more roads on the network to create a hierarchy of road robustness. More targeted allocation of resources
