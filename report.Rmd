...
These options are provided to the function as argument ("time", "hour", "rush"). As the time frame widens, more data is available for standardization. This is why in addition to standardizing the data, the `standardiser` function also displays the total number of data points present in each time frame according to the method chosen. The function also removes observations greater than three standard deviations away as these are outliers that can affect the analysis.
